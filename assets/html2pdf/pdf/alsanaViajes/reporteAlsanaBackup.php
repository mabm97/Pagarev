	...
	<table class="tabFooter">
		<tr>
			<th>
				...
				<label class="termsConditions">LA PRESENTE NOTA FORMA PARTE DE LA FACTURA DEL PERIODO FISCAL POR VENTAS AL PUBLICO EN GENERAL.<br/>Al realizar tu pago estas aceptando nuestros terminos y condiciones, LEER EN: https://goo.gl/mYdsZG<br/>
